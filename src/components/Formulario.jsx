      ...
      <Formik
        ...
        validate={(info) => {
          ...
          if (!info.enlace) {
            ...
            /^(https?:\/\/)?(www\.)?youtube\.com\/(watch\?v=|embed\/|v\/|.+\?v=)?([a-zA-Z0-9_-]{11})$/.test(
              info.enlace
            )
          ) {
        ...
        {({ errors }) => (
          <Form className="formulario" encType="multipart/form-data">
            <div>
              ...
              <ErrorMessage
                name="artistaBanda"
                component={() => <div>{errors.artistaBanda}</div>}
              />
            </div>
            <div>
              ...
              <ErrorMessage
                name="cancion"
                component={() => <div>{errors.cancion}</div>}
              />
            </div>
            ...
            <div>
              ...
              <ErrorMessage
                name="enlace"
                component={() => <div>{errors.enlace}</div>}
              />
            </div>
            <div>
              <Field
